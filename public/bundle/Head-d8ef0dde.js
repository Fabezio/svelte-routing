...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, a as validate_slots, e as space, f as element, t as text, u as attr_dev, h as add_location, j as insert_dev, k as append_dev, l as set_data_dev, w as noop, q as detach_dev } from './main-daf95cb1.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			h2 = element("h2");
			t3 = text(/*head*/ ctx[0]);
			attr_dev(h1, "class", "svelte-1hfzltj");
			add_location(h1, file, 8, 0, 133);
			attr_dev(h2, "class", "svelte-1hfzltj");
...
export { Head as H };
//# sourceMappingURL=Head-d8ef0dde.js.map
