...
function create_fragment(ctx) {
	...
	let a1_href_value;
	let current;
	head = new Head({ props: { head: info }, $$inline: true });
...
class U5Binfou5D extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*slug*/ ctx[0] === undefined && !("slug" in props)) {
			console.warn("<U5Binfou5D> was created without expected prop 'slug'");
		}
	}
...
//# sourceMappingURL=[info]-d918cc05.js.map
