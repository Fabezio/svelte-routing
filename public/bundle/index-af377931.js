...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a0, file, 8, 0, 114);
			add_location(br0, file, 8, 40, 154);
			attr_dev(a1, "href", a1_href_value = /*$url*/ ctx[0]("blog/truc"));
			add_location(a1, file, 9, 0, 159);
			add_location(br1, file, 9, 36, 195);
			attr_dev(a2, "href", a2_href_value = /*$url*/ ctx[0]("blog/bidule"));
			add_location(a2, file, 10, 0, 200);
		},
...
export default Blog;
//# sourceMappingURL=index-af377931.js.map
