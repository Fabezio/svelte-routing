...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_store, c as component_subscribe, a as validate_slots, b as create_component, e as space, f as element, t as text, z as attr_dev, h as add_location, m as mount_component, j as insert_dev, k as append_dev, n as transition_in, o as transition_out, p as destroy_component, q as detach_dev } from './main-b633fcdc.js';
import { H as Head } from './Head-50397cd8.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			a = element("a");
			t1 = text("see more");
			attr_dev(a, "href", a_href_value = /*$url*/ ctx[1](`blog/${/*slug*/ ctx[0]}`));
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*$url, slug*/ 3 && a_href_value !== (a_href_value = /*$url*/ ctx[1](`blog/${/*slug*/ ctx[0]}`))) {
...
//# sourceMappingURL=index-dd813afb.js.map
