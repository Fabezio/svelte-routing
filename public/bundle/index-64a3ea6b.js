...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a1, "href", a1_href_value = /*$url*/ ctx[1](`blog/${/*slug*/ ctx[0]}/`));
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*$url, slug*/ 3 && a1_href_value !== (a1_href_value = /*$url*/ ctx[1](`blog/${/*slug*/ ctx[0]}/`))) {
...
//# sourceMappingURL=index-64a3ea6b.js.map
