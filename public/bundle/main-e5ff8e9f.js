  ...
  "children": [
    {
      ...
      "path": "/about",
      "id": "_about",
      "component": () => import('./about-a112279f.js').then(m => m.default)
    },
    {
      "isFile": true,
      "isDir": false,
      ...
      "path": "/index",
      "id": "_index",
      "component": () => import('./index-15e1378c.js').then(m => m.default)
    }
  ],
  "isLayout": false,
  "isReset": false,
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file$2, 9, 14, 204);
			add_location(p, file$2, 9, 1, 191);
...
//# sourceMappingURL=main-e5ff8e9f.js.map
